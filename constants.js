export const QUADRANT_ONE_INFO = [
    {
  ...
  export const QUADRANT_TWO_INFO = [
    {
    ...
    {
      name: "Leadership Style & Philosophy",
      content: [
  ...
  export const QUADRANT_THREE_INFO = [
    {
